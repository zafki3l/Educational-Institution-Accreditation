                ...
                <section class="card staff-info-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="profile-details">
                            ...
                            <p><strong>Role:</strong> <?= htmlspecialchars(($_SESSION['user']['role_id'] ?? 0) == App\Domain\Entities\Models\User::ROLE_BUSINESS_STAFF ? 'Staff' : 'Admin') ?></p>
                        </div>
                    </div>
                </section>
                ...
                <section class="card inventory-card">
                    ...
                    <div class="card-body">
                        <div class="management-links">
                            <a class="manage-link" href="/<?= PROJECT_NAME ?>/staff/standards">
                                <i class="fa-solid fa-tags"></i>
                                Cập nhật tiêu chuẩn
                            </a>
                            <a class="manage-link" href="/<?= PROJECT_NAME ?>/staff/criterias">
                                <i class="fa-solid fa-tags"></i>
                                Cập nhật tiêu chí
                            </a>
